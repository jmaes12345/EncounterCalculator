...
class PCThresholdEngineTest {
    ...
    void testCalculatePCThresholds(int tooEasy, int easy, int medium, int hard, int deadly, int impossible, PCParty PCParty) {
        Map<Difficulty, Integer> expectedThresholds = PCThresholdEngine.generateThresholdMap(tooEasy, easy, medium, hard, deadly, impossible);
    ...
    void testGenerateThresholdMap() {
        Map<Difficulty, Integer> thresholdMap = PCThresholdEngine.generateThresholdMap();
